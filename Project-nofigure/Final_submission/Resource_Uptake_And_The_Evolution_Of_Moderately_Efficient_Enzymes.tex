\documentclass[nogrid,crop,final]{MBE2}%
...
\title[Resource uptake and the evolution of moderately efficient enzymes]{Resource uptake and the evolution of moderately efficient enzymes}

%%%Peut-être qu'il faudrait que le titre indique que c'est un travail de modélisation?
%%J'ai l'impression qu'on peut se passer de le mentionner dans le titre pour se concentrer sur notre message
%%%Je garderais bien the evolution of moderately efficient enzymes. Ou "Competition for ressources and the evolution of moderately efficient enzymes"
%%En fait, si on met trop en avant l'aspect compétition pour la ressource, j'ai l'impression qu'on s'attend à un article de simulations en environnement dynamique, où la compétition a explicitement lieu.

\author[Labourel et al.]{Florian Labourel,$^{\ast,1}$ Etienne Rajon,$^{1}$}
\address{$^{1}$Univ Lyon, Université Lyon 1, CNRS,
    Laboratoire de Biométrie et Biologie Evolutive UMR5558,
    F-69622 Villeurbanne, France}
\history{}
\coresp{e-mail: florian.labourel@univ-lyon1.fr}
\datade{Enzymes data were recovered from \citep{Bar-Even11}}
\editor{MBE}
...
\begin{figure*}[t!]
\centering
\includegraphics[scale=0.575,trim=0cm 0.5cm 0 1cm,clip]{Figures/3DFitLandscape.jpeg} 
...
Supplementary material is available at \textit{Molecular Biology and Evolution} online. %Molecular Biology and Evolution
