    ...
    #Resident phenotype
      ...
      for (t in 1:G){
        ...
        for (i in 1:length(Cell_tab[["N"]])){
          Cell_tab[["fit"]][i]<-fit(Cell_tab[["kf"]][i],kr_i,Cell_tab[["kcat"]][i],Cell_tab[["Econc"]][i])
        }
            ...
            for (m in 1:mut_table[i]){
              ...
              if(mut_bias=="increasing"){
                ...
                Cell_tab[["Econc"]][length(Cell_tab[["N"]])+1]<-Cell_tab[["Econc"]][i]
                  ...
                  mut_delta_enz<-rnorm(1,mean=0,sd=0.2)
...
#}
  if(mut_bias=="increasing"){
    save(simul,evo_results,file=paste("eq_",flux,"_Ne",Ne,"_mu",-log10(mu),"_bi0",3,"ConcMutCorr.rda",sep=""))
  }
  if(mut_bias!="increasing"){
    save(simul,evo_results,file=paste("eq_",flux,"_Ne",Ne,"_mu",-log10(mu),"_bi0",-mut_bias*10,"ConcMutCorr.rda",sep=""))
  }
