...
b=mut_bias_set[2]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$g_set,xlab="Time",ylab="Log10 Flux(M)",ylim=c(-6.1,-6))
...
text(x=12,y=-6.05,labels=expression(paste("Ne=",10^2)),srt=-90,xpd=NA,font=2,cex=1)
...
dev.print(device = jpeg, file = "Evo_SteadyState_MutCorr_LowF.jpeg", width = 700*3,height=1400*3,res=100*3,type="cairo")
...
text(0.425,0.959,"0.99",srt=-90,font=1,col=1,cex=1.75,family="serif")
text(0.525,0.948,"0.999",srt=-90,font=1,col=2,cex=1.75,family="serif")
text(0.625,0.937,"0.9999",srt=-90,font=1,col=3,cex=1.75,family="serif")
text(0.725,0.926,"0.99999",srt=-90,font=1,col=4,cex=1.75,family="serif")
...
setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "2DFitLandscape_Evo_Results_lowF_withbias_MutCorr.jpeg", width = 550*3,height=460*3,res=100*3,type="cairo")
...
for (f in flux_set){
  for(n in Ne_set){
    for(b in mut_bias_set){
      ...
      kr<-10^3
      print(paste(f,n,mu,b))
      load(paste("/Users/florian/Desktop/enzyme-evolution/Evo_Results/","eq_",f,"_Ne",n,"_mu",-log10(mu),"_bi0",-b*10,"HighMutCorr.rda",sep=""))
      if(b==0){
        assign(paste("eq_",f,"_Ne",n,"_mu",-log10(mu),"_bi00",sep=""),evo_results)
      }
      else{
...
##Fit
#boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==0,]$fitness/max(data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==0,]$fitness))~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==0,]$Ne,col=c("green"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$Ne,col=c("blue"),ylim=c(-6,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$Ne,col=c("red"),ylim=c(-6,-1),xlab="Ne",ylab="Drift strength")
text(x=5,y=-3.5,labels=paste("Steady-state flux"),srt=-90,xpd=NA,font=1,cex=1)

setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "Evo_SteadyState_HighMutCorr_LowF.jpeg", width = 700*3,height=1400*3,res=100*3,type="cairo")
...
setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "2DFitLandscape_Evo_Results_lowF_withbias_HighMutCorr.jpeg", width = 550*3,height=460*3,res=100*3,type="cairo")
...
for (f in flux_set){
  for(n in Ne_set){
    for(b in mut_bias_set){
      ...
      kr<-10^3
      print(paste(f,n,mu,b))
      load(paste("/Users/florian/Desktop/enzyme-evolution/Evo_Results/","eq_",f,"_Ne",n,"_mu",-log10(mu),"_bi0",-b*10,"PosMutCorr.rda",sep=""))
      if(b==0){
        assign(paste("eq_",f,"_Ne",n,"_mu",-log10(mu),"_bi00",sep=""),evo_results)
      }
      else{
...
##Fit
#boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==0,]$fitness/max(data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==0,]$fitness))~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==0,]$Ne,col=c("green"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$Ne,col=c("blue"),ylim=c(-7,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$Ne,col=c("red"),ylim=c(-7,-1),xlab="Ne",ylab="Drift strength")
text(x=5,y=-4,labels=paste("Steady-state flux"),srt=-90,xpd=NA,font=1,cex=1)

setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "Evo_SteadyState_PosMutCorr_LowF.jpeg", width = 700*3,height=1400*3,res=100*3,type="cairo")


#Plotting on fitness landscapes
N_reso=100#250
KT_set=c(10^-5) #Molar, Michaelis-like saturation constant for facilitated diffusion
...
text(addtxt2$l,addtxt2$h,addtxt2$txt[3],srt=addtxt2$srt,font=addtxt2$font,col=addtxt2$col,cex=2)
text(addtxt12$l,addtxt12$h,addtxt12$txt[1],srt=addtxt12$srt,font=addtxt12$font,col=addtxt12$col,cex=2)
setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "2DFitLandscape_Evo_Results_lowF_withbias_PosMutCorr.jpeg", width = 550*3,height=460*3,res=100*3,type="cairo")
