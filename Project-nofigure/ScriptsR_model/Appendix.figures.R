...
#setwd(dir="enzyme-evolution/Data")
...
###9a.Analysis of Evolutionary Results - model wihtout concentration but full analysis of mutational biases
...
par(mfrow=c(5,3),mai=c(0.55,0.75,0.45,0.45))
...
#logn<-log(n,10)
b=mut_bias_set[1]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$g_set,xlab="Time",ylab="Log10 Flux(M)")
title(main="No mutational bias (b = 0)")
b=mut_bias_set[2]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$g_set,xlab="Time",ylab="Log10 Flux(M)")
...
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$Ne,col=c("blue"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$Ne,col=c("red"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
text(x=5,y=-5.5,labels=paste("Steady-state flux"),srt=-90,xpd=NA,font=1,cex=1)

setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "Evo_SteadyState_LowF.jpeg", width = 1000*3,height=1400*3,res=100*3,type="cairo")
...
##Fit
boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==0,]$fitness/max(data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==0,]$fitness))~data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==0,]$Ne,col=c("green"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==-0.1,]$fitness/Max_val[["H"]])~data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==-0.1,]$Ne,col=c("blue"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==-0.2,]$fitness/Max_val[["H"]])~data_fit_eq[["H"]][data_fit_eq[["H"]]$bias==-0.2,]$Ne,col=c("red"),ylim=c(-10,-1),xlab="Ne",ylab="Drift strength")
text(x=5,y=-5.5,labels=paste("Steady-state flux"),srt=-90,xpd=NA,font=1,cex=1)

setwd(dir="~")
setwd(dir="enzyme-evolution/Paper/Figures")
dev.print(device = jpeg, file = "Evo_SteadyState_HighF.jpeg", width = 1000*3,height=1400*3,res=100*3,type="cairo")
...
b=mut_bias_set[1]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="No bias")
n=Ne_set[2]
...
b=mut_bias_set[2]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="Low bias")
n=Ne_set[2]
...
b=mut_bias_set[3]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="Moderate bias")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=16,col="light green")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=17,col="green")
...
#Weak flux, high and varying bias
f="W"
b=mut_bias_set[4]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="High and varying bias")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-4,6))
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=17,col="green")
...
#High flux, high and varying bias
f="H"
b=mut_bias_set[4]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="High and varying bias")
...
###9b1.Analysis of Evolutionary Results - with concentration and only diffusion problems
...
b=mut_bias_set[2]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_bi0",-b*10,sep=""))$g_set,ylim=c(-6.09,-6.03))
...
par(mfrow=c(1,3))
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.1,]$Ne,col=c("yellow", "light green","green","dark green"),ylim=c(-10,-1),xlab="Ne",ylab="1-f")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.2,]$Ne,col=c("yellow", "light green","green","dark green"),ylim=c(-10,-1),xlab="Ne",ylab="1-f")
boxplot(log10(1-data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.3,]$fitness/Max_val[["W"]])~data_fit_eq[["W"]][data_fit_eq[["W"]]$bias==-0.3,]$Ne,col=c("yellow", "light green","green","dark green"),ylim=c(-10,-1),xlab="Ne",ylab="1-f")
...
b=mut_bias_set[1]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=17,col="green",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
n=Ne_set[4]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_bi0",-b*10,sep=""))),pch=18,col="dark green",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
...
###9b.Analysis of Evolutionary Results - enzyme concentrations with cost
...
n=Ne_set[1]
c=cost_set[1]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_c",c,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_c",c,sep=""))$g_set)
c=cost_set[2]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_c",c,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_c",c,sep=""))$g_set)
c=cost_set[3]
boxplot(log10(get(paste("Fit_evo_time",f,"_Ne",n,"_c",c,sep=""))$tempo_time_Fit)~get(paste("Fit_evo_time",f,"_Ne",n,"_c",c,sep=""))$g_set)
...
##c.Plotting fitness and average enzyme concentrations values at steady-state #does not work for the moment
max(data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==100,]$fitness)

boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==100,]$fitness/max(data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==100,]$fitness))~data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==100,]$Ne,col=c("yellow","light green","green","dark green"))
boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^3,]$fitness/max(data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==1000,]$fitness))~data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^3,]$Ne,col=c("yellow","light green","green","dark green"))
boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^4,]$fitness/max(data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^4,]$fitness))~data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^4,]$Ne,col=c("yellow","light green","green","dark green"))
boxplot(log10(1-data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^5,]$fitness/max(data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^5,]$fitness))~data_fit_eq[["H"]][data_fit_eq[["H"]]$cost==10^5,]$Ne,col=c("yellow","light green","green","dark green"))
...
c=cost_set[1]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="High protein cost")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=17,col="green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
n=Ne_set[4]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=18,col="dark green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")

#High cost
f="H"
c=cost_set[2]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="Moderate protein cost")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=17,col="green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
...
c=cost_set[3]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="Low protein cost")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=17,col="green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
...
c=cost_set[4]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat",main="Very low protein cost")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("kcat_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=17,col="green",xlim=c(0,10),ylim=c(-4,6),xlab="log10 kcat/KM",ylab="log10 kcat")
...
c=cost_set[1]
n=Ne_set[1]
plot(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=15,col="yellow",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
n=Ne_set[2]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=16,col="light green",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
n=Ne_set[3]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=17,col="green",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
n=Ne_set[4]
points(log10(get(paste("kcat_KM_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),log10(get(paste("Econc_ev_eq_fl",f,"_Ne",n,"_c",c,sep=""))),pch=18,col="dark green",xlim=c(0,10),ylim=c(-7,1),xlab="log10 kcat/KM",ylab="[Etot]")
...
###9c.Analysis of Evolutionary Results - mutational correlations
...
for (f in flux_set){
  for(n in Ne_set){
    for(b in mut_bias_set){
      ...
      kr<-10^3
      print(paste(f,n,mu,b))
      load(paste("/Users/florian/Desktop/enzyme-evolution/Evo_Results/","eq_",f,"_Ne",n,"_mu",-log10(mu),"_bi0",-b*10,"MutCorr.rda",sep=""))
      if(b==0){
        assign(paste("eq_",f,"_Ne",n,"_mu",-log10(mu),"_bi00",sep=""),evo_results)
      }
      else{
